 ...
 * @example
 * ```typescript
 * import { CHAT_SENDERS, type ChatSender, getChatSenderName } from '@/components/const'
 * 
 * // 创建消息
 ...
 * 
 * // 获取显示名称
 * console.log(getChatSenderName(CHAT_SENDERS.USER))  // '用户'
 * console.log(getChatSenderName(CHAT_SENDERS.AGENT)) // 'AI助手'
 * ```
 */
